...
// CODE HERE
const paramNames = (name1, name2) => console.log(`the First parameter is ${name1}. The second parameter is ${name2}`)



// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.
// paramNames("Scott", "Tom")
...
// greeting("Scott","Nelson", (fullName) => 
...
// CODE HERE
let pricesPlusTax = (arr, callback) => {
    for(let i = 0; i < arr.length; i++) {
